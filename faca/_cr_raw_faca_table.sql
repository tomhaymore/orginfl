...
CREATE TABLE raw_faca (
	...
	comm_org_id BIGINT NULL,
  	...
  	indiv_end DATE NULL,
	comm_added INT(1) DEFAULT NULL,
	org_added INT(1) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE INDEX firstnamefaca ON raw_faca (firstname(450));
CREATE INDEX middlenamefaca ON raw_faca (middlename(450));
CREATE INDEX lastnamefaca ON raw_faca (lastname(450));